...
func TestValidators(t *testing.T) {
	...
	jot := &JWT{
		...
		ID:             "jti",
		Audience:       []string{"aud", "second_aud"},
		Subject:        "sub",
		Issuer:         "iss",
	}
	testCases := []struct {
		...
		{AudienceValidator(), nil},
		{AudienceValidator("aud"), nil},
		{AudienceValidator("second_aud"), nil},
		{AudienceValidator("aud", "second_aud"), nil},
		{AudienceValidator("not_aud"), ErrAudValidation},
		{AudienceValidator("aud", "not_aud"), ErrAudValidation},
