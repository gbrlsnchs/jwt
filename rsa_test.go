...
func TestRSA(t *testing.T) {
	...
	testCases := []testCase{
		...
		{NewRS256(nil, nil), NewRS256(nil, nil), nil, ErrNoRSAPrivKey, nil, nil, nil},
		{NewRS256(priv, nil), NewRS256(nil, nil), nil, nil, nil, nil, ErrNoRSAPubKey},
		...
		{NewRS384(nil, nil), NewRS384(nil, nil), nil, ErrNoRSAPrivKey, nil, nil, nil},
		{NewRS384(priv, nil), NewRS384(nil, nil), nil, nil, nil, nil, ErrNoRSAPubKey},
		...
		{NewRS512(nil, nil), NewRS512(nil, nil), nil, ErrNoRSAPrivKey, nil, nil, nil},
		{NewRS512(priv, nil), NewRS512(nil, nil), nil, nil, nil, nil, ErrNoRSAPubKey},
	}
	testJWT(t, testCases)
}
